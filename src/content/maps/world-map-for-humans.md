...
description: "An exploratory interactive map that gives geographic context through coastlines, water, population, urban areas, and satellite imagery—without political boundaries."
date: 2026-08-29
...
tools: [MapLibre GL JS, OpenStreetMap, Natural Earth, Copernicus GHSL, ESA WorldCover]
...
There is no conventional basemap underneath these layers. Land begins as a quiet paper-like field; water defines its edge, population and urban areas register human concentration, and WorldCover can replace abstraction with either classified land cover or false-colour Earth observation. The result is deliberately informative but incomplete.
